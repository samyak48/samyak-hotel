...
function UpdateProfileForm({ guest, children }) {
    // console.log(guest)
    const { fullName, email, nationality, nationalID, country, countryFlag } = guest
        ...
        <form action={updateGuest} className="bg-primary-900 py-8 px-12 text-lg flex gap-6 flex-col">
            <div className="space-y-2">
                ...
                <input
                    ...
                    name='fullName'
                    className="px-5 py-3 bg-primsary-200 text-primary-800 w-full shadow-sm rounded-sm disabled:cursor-not-allowed disabled:bg-gray-600 disabled:text-gray-400"
                />
            </div>
            ...
            <div className="flex justify-end items-center gap-6">
                {/* <Button /> */}
                <SubmitButton pendindLabel="Updateing..." >
                    Update profile
                </SubmitButton>
            </div>
        </form>
